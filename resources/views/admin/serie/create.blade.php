...
@section('title', '180 Inspire admin dashboard | Create New Serie, Album and Playlist')
...
@section('content')
    ...
    <div>
        ...
        @endif
        <form class="custom-form" enctype="multipart/form-data" action="{{ route('admin.serie.store') }}" method="POST">
            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
            <div class="uk-flex">
                <!-- Card Form -->
                <div class="uk-flex-1">
                    <h2 class="form-title uk-text-center">
                        Create New Album, Playlist &amp; Serie
                        <span>
                        ...
                        <div class="uk-container">
                            ...
                            <div class="uk-width-1-1">
                                ...
                                <div class="custom-form-group">
                                    <div class="uk-width-1-1">
                                        <input type="text" placeholder="Album, Serie, Playlist title here ..." name="title" class="custom-input-text" required/>
                                    </div>
                                </div>
                ...
                <div class="sidebar-form-advance">
                    ...
                    <div class="advance-options">
                        ...
                        <div class="custom-form-group">
                            <div class="uk-width-1-1">
                                <input type="text" placeholder="Genre" name="genre" class="custom-input-text" />
                            </div>
                        </div>
